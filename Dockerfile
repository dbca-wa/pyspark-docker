...
COPY utils.py oracle_financials_logins.py http_requests_single_host.py http_requests_ip.py http_requests_domain_hourly_counts.py http_requests_domain_daily_counts.py ./
